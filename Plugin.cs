...
public sealed class Plugin : IDalamudPlugin
{
        ...
        ITextureProvider textureProvider)
    {
        ...
        var simulationDirectory = Path.Combine(pluginInterface.GetPluginConfigDirectory(), "simulation_policy");
        var precomputedFile = Path.Combine(pluginInterface.GetPluginConfigDirectory(), "precomputed_policy.json");
        if (this.Configuration.PrecomputedPolicyEnabled && !Directory.Exists(simulationDirectory) && !File.Exists(precomputedFile))
        {
            ...
            this.PrecomputedPolicy = new OptionalComponentState(false, "No table installed (optional; generated by tools/Precompute).");
        ...
        else if (this.Configuration.PrecomputedPolicyEnabled)
        {
            try
            {
                ...
                else
                {
                    ...
                    this.PrecomputedPolicy = new OptionalComponentState(true, $"precomputed_policy.json ({table.Count} belief states)");
