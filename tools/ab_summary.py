...
def main():
    ...
    header = f"{'model':<17}{'pop':<7}{'hands':>6}{'win':>7}{'dealin':>8}{'tsumo-':>8}{'drawT':>7}{'riichi':>8}{'dealin@R':>10}{'mean d':>9}{'total d':>10}"
    print(header)
    for (model, pop), rows in sorted(groups.items()):
        ...
        mean = sum(deltas) / n
        print(f"{model:<17}{pop:<7}{n:>6}{wins:>7.1%}{dealin:>8.1%}{tsumo_loss:>8.1%}{draw_t:>7.1%}{riichi:>8.1%}{dealin_vs_riichi:>10.1%}{mean:>9.0f}{sum(deltas):>10}")
